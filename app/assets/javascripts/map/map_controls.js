...
MAP_CONTROLS.point_button = function() {
    ...
    button.innerHTML = '<i class="fa fa-map-marker"></i>' +
                       '<span class="control-title">Point</span>';
...
MAP_CONTROLS.polygon_button = function() {
    ...
    button.innerHTML = '<i class="fa fa-square-o"></i>'+
                       '<span class="control-title">Polygon</span>';
...
MAP_CONTROLS.edit_button = function() {
    ...
    button.innerHTML = '<i class="fa fa-pencil-square-o" id="edit-button"></i>' +
                       '<span class="control-title">Edit</span>';
...
MAP_CONTROLS.remove_button = function() {
    ...
    button.innerHTML = '<i class="fa fa-times"></i>' +
                       '<span class="control-title">Remove</span>';
...
MAP_CONTROLS.remove_all_button = function() {
    ...
    button.innerHTML = '<i class="fa fa-trash-o"></i>' +
                       '<span class="control-title">Remove All</span>';

    var handleRemoveAll = function() {
        map.removeInteraction(MAP_CONTROLS.current_interaction);
        $('#active-control').removeAttr('class');
...
MAP_CONTROLS.toggle_button = function(button) {
    ...
    if (is_active_control) {
        ...
        // TO BE REMOVED
        $('#active-control').addClass("active")
        return true
    }
};
...
MAP_CONTROLS.snap_to_controls.disable_snap_to = function() {
    ...
    document.getElementById('snap-to-icon').className = 'fa fa-times'
...
MAP_CONTROLS.snap_to = function() {
    ...
    button.innerHTML = '<i id="snap-to-icon" class="fa fa-times"></i>' +
                       '<span class="control-title">Snap-to</span>';
    ...
    var handleSnapTo = function () {
        if (MAP_CONTROLS.snap_to_controls.snap_to_enabled) {
            ...
            document.getElementById('snap-to-icon').className = 'fa fa-check'
        }
    }
