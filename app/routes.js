...
router.get('/search-llc/v4-2/search-results', (req, res, next) => {
    res.render('search-llc/v4-2/search-results')
})

router.get('/search-llc/v4-2/pay-successful', (req, res, next) => {
    const reference = req.params['reference']
    ...
    payments.checkPaymentStatus(id, (result) => {
        ...
        res.render('search-llc/v4-2/pay-successful', {
            transaction: result
        })
    })
})

router.post('/search-llc/v4-2/search-results', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v4-2/search-results-from-map', (req, res, next) => {
    res.render('search-llc/v4-2/search-results-from-map')
})
...
router.post('/search-llc/v4-2/search-results-from-map', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v4-3/search-results', (req, res, next) => {
    res.render('search-llc/v4-3/search-results')
})

router.get('/search-llc/v4-3/pay-successful', (req, res, next) => {
    const reference = req.params['reference']
    ...
    payments.checkPaymentStatus(id, (result) => {
        ...
        res.render('search-llc/v4-3/pay-successful', {
            transaction: result
        })
    })
})

router.post('/search-llc/v4-3/search-results', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v4-3/search-results-from-map', (req, res, next) => {
    res.render('search-llc/v4-3/search-results-from-map')
})
...
router.post('/search-llc/v4-3/search-results-from-map', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v4-4/search-results', (req, res, next) => {
    res.render('search-llc/v4-4/search-results')
})

router.get('/search-llc/v4-4/pay-successful', (req, res, next) => {
    const reference = req.params['reference']
    ...
    payments.checkPaymentStatus(id, (result) => {
        ...
        res.render('search-llc/v4-4/pay-successful', {
            transaction: result
        })
    })
})

router.post('/search-llc/v4-4/search-results', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v4-4/search-results-from-map', (req, res, next) => {
    res.render('search-llc/v4-4/search-results-from-map')
})
...
router.post('/search-llc/v4-4/search-results-from-map', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v4-5/search-results', (req, res, next) => {
    res.render('search-llc/v4-5/search-results')
})

router.get('/search-llc/v4-5/pay-successful', (req, res, next) => {
    const reference = req.params['reference']
    ...
    payments.checkPaymentStatus(id, (result) => {
        ...
        res.render('search-llc/v4-5/pay-successful', {
            transaction: result
        })
    })
})

router.post('/search-llc/v4-5/search-results', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v4-5/search-results-from-map', (req, res, next) => {
    res.render('search-llc/v4-5/search-results-from-map')
})
...
router.post('/search-llc/v4-5/search-results-from-map', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v4-8/search-results', (req, res, next) => {
    res.render('search-llc/v4-8/search-results')
})

router.get('/search-llc/v4-8/pay-successful', (req, res, next) => {
    const reference = req.params['reference']
    ...
    payments.checkPaymentStatus(id, (result) => {
        ...
        res.render('search-llc/v4-8/pay-successful', {
            transaction: result
        })
    })
})

router.post('/search-llc/v4-8/search-results', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v4-8/search-results-from-map', (req, res, next) => {
    res.render('search-llc/v4-8/search-results-from-map')
})
...
router.post('/search-llc/v4-8/search-results-from-map', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v5-2/search-results', (req, res, next) => {
    res.render('search-llc/v5-2/search-results')
})

router.get('/search-llc/v5-2/pay-successful', (req, res, next) => {
    const reference = req.params['reference']
    ...
    payments.checkPaymentStatus(id, (result) => {
        ...
        res.render('search-llc/v5-2/pay-successful', {
            transaction: result
        })
    })
})

router.post('/search-llc/v5-2/search-results', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
...
router.get('/search-llc/v5-2/search-results-from-map', (req, res, next) => {
    res.render('search-llc/v5-2/search-results-from-map')
})
...
router.post('/search-llc/v5-2/search-results-from-map', (req, res, next) => {
    req.body.amount = '1500'
    req.body.reference = 'Official search result of local land charges'
    req.body.description = 'Official search result of local land charges'
